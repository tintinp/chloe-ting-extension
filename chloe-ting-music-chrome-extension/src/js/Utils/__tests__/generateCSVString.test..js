describe('generateCSVString', () => {
  ...
  test('remove correct timestamp', () => {
    ...
    const expected =
      `class,timestamp,a,delta_a,b,delta_b,array1_1,array1_2,array2_1,array2_2\r\n` +
      `2,10500,2,1,1,0,3,4,10,10\r\n` +
      `0,12000,5,1,1,0,9,10,1,1\r\n` +
      `1,12500,6,1,1,0,3,3,10,10\r\n` +
      `1,13500,8,1,1,0,5,5,10,10`
